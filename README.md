...
> **Prereq: cli-maxxing** — install [`cli-maxxing`](https://github.com/fidgetcoding/cli-maxxing) first.
>
...
```bash
curl -fsSL https://github.com/fidgetcoding/creativity-maxxing/install.sh | bash
```
...
```bash
curl -fsSL https://github.com/fidgetcoding/creativity-maxxing/uninstall.sh | bash
```
...
- [`cli-maxxing`](https://github.com/fidgetcoding/cli-maxxing) — the
