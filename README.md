...
> **Prereq: cli-maxxing** — install [`cli-maxxing`](https://github.com/fidgetcoding/cli-maxxing) first. This repo assumes `claude` is on your `PATH` and `~/.claude/skills/` already exists.
...
| Repo | What it does |
|------|-------------|
| [`cli-maxxing`](https://github.com/fidgetcoding/cli-maxxing) | Foundation — Claude Code, shell aliases, Ruflo, dev tools, productivity MCPs |
| **`creativity-maxxing`** | **This repo** — design skills + video/audio pipeline |
| [`2ndbrain-maxxing`](https://github.com/fidgetcoding/2ndbrain-maxxing) | Obsidian PKM vault setup, cbrain/cbraintg commands |
